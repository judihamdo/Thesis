...
"""
Was macht total_ordering? Wenn du in einer Klasse einige Vergleichs-Methoden implementierst, z. B.:__lt__, __eq__

Python braucht alle Vergleichsoperatoren (<, <=, >, >=) : total_ordering erzeugt automatisch die fehlenden Methoden, z. B. <=, >, >=, basierend auf < und ==.
from functools import total_ordering
...
print(a < b)   # True
print(a <= b)  # True (automatisch erzeugt)
print(a > b)   # False (automatisch erzeugt)
"""
